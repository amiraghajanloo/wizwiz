...
do
	case $opt in
		"Update bot")
			...
			sleep 3
			git clone https://github.com/amiraghajanloo/wizwiz.git /var/www/html/wizwizxui-timebot
...
# 			fi
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/amiraghajanloo/wizwiz/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
